...
The gameplay issue **is how slow the turret changes targets whenever its current target dies**. It sometimes takes a second or two before it can switch targets as you can see in this gif.
...
Playing it again and now the turrets will switch targets immediately when its current target dies.
